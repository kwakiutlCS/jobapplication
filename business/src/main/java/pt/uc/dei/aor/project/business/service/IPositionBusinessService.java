...
public interface IPositionBusinessService {
	...
	IPosition createNewPosition(String code, Date openingDate, String title, Collection<Localization> localizations, PositionState state, int vacancies, Date closingDate, String sla, 
